...
mMaps.insert(std::make_pair("glsl_sgfp4_dequant_comp", std::make_pair(glsl_sgfp4_dequant_comp,glsl_sgfp4_dequant_comp_len)));
mMaps.insert(std::make_pair("glsl_sgfp4_dequant_FP16_comp", std::make_pair(glsl_sgfp4_dequant_FP16_comp,glsl_sgfp4_dequant_FP16_comp_len)));
